...
<div id=announcements class="section secondary-section">
    ...
    <div class="container">
        ...
        <div class="row-fluid" style="margin-bottom:20px">
            <div class="span8">
                <img src="<?php echo base_url() ?>assets/contents/images/tempory/Niwarana competition.jpg">
            </div>
            <div class="span4">
                <p>
                    ඔබේ අදහසට ලියෝ අපෙන් අවස්ථාවක්.... 📝<br>
                    <br>
                    මත්ද්‍රව්‍ය භාවිතයෙන් සිදුවන අහිතකර බලපෑම විස්තර කෙරෙන කෙටි නාට්‍ය පිටපතක් අප වෙත එවන්න.<br>
                    <br>
                    <a href="https://forms.gle/qqvCDxy1A1F5qFLM7">https://forms.gle/qqvCDxy1A1F5qFLM7</a>
                    <br>
                    අප ලබා දී ඇති නිමල්ගේ චරිතය වටා ගෙතුණු, වචන දහසකට (1000) වඩා නොවැඩි කිසිදු ආයතනයක, ප්‍රසිද්ධ පුද්ගලයන්ගේ නම් සදහන් නොවූ මනඃකල්පිත චරිතවලින් නිම වූ ඔබේ කෙටි නාට්‍ය පිටපත දෙසැම්බර් 15ට පෙර ඉහත link එක හරහා අපට එවන්න.
                    (වැඩි විස්තර, තිර පිටපතේ ආරම්භක කොටස සහ තරගයට අදාල අයදුම්පත ඉහත link එක හරහා ලබා ගත හැක.) <br>
                    <br>
                    <b> #නිවාරණ_2020<br>
        ...
        <div class="row-fluid" style="margin-bottom:20px">
            <div class="span8">
                <img src="<?php echo base_url() ?>assets/contents/images/tempory/Sidu nala raksha.jpeg">
            </div>
            <div class="span4">
                <p>
                    සත්ත්ව හා පාරිසරික සංරක්ෂණය පදනම් කොට ගෙන ක්‍රි‍යාත්මක වන සිඳු නළ රක්‍ෂා ව්‍යාපෘතියේ ප‍්‍රථම අදියර ලෙස සාගර හා ජලාශ්‍රිත ජීවය රැක ගැනීමට ඔබ සැමගේ ඇති වගකීම මතක් කර දීමට, කොළඹ විශ්ව විද්‍යාලයීය ලියෝ සමාජයේ අප සූදානම්...<br>
                    <br>
                    හඬක් නැත්තවුන් වෙනුවෙන් හඬක් වන්නට, අප හා අත්වැල් බැඳගන්න <br>
                    <br>
                    <b> #සිඳුනළරක්ෂා 🌿🌍<br>
                        #තුම්මුල්ලේ_සිංහයෝ <br>
                        #UOC_Leos<br>
