    ...
    <div class="container">
        ...
        <div class="title">
            ...
            <div style="text-align:justify">
                ...
                <p>Leo Club of University of Colombo is an affiliate of Leo Club International that focuses on to provide the youth of the world with an opportunity for development and contribution, individually and collectively, as responsible members of the local, national and international community.</p>
                <p>
...
<div id=announcements class="section secondary-section">
    ...
    <div class="container">
        ...
        <!-- <div id="Prakampana" class="row-fluid" style="margin-bottom:20px">
            <div class="span8">
                <img src="<?php echo base_url() ?>assets/contents/images/tempory/Alert 4.0.jpeg">
            </div>
            <div class="span4">
                <p>
                    නත්තල් අසිරිය විදින්න <br>
                    පුංචි හිත් කෙතරම් මනාපද..<br>
                    නමුත්, දහසකුත් පුංචි හිත්<br>
                    පිළිකා රෝහලේ සිරවෙලා..<br>
                    ආසාවෙන් ඇති ඒ කැකුලු සමරන්නට තුටින් නත්තල්.. <br>
                    නත්තලට අරුතක් එක්කරන්නට<br>
                    එන්න අප හා එක්වන්න. <br>
                    <br>
                    පිළිකා රෝහලේ ළමුන් සදහා අඩුවක්ව පැවැති බෙහෙත් ද්‍රව්‍ය සහ මානසික චිකිත්සාව උදෙසා සංගීතමය ප්‍රතිකාර ලබා දීමට අවශ්‍ය ශබ්ද පද්ධතිය පරිත්‍යාග කිරීම සහ කැද දානය ලබා දීම...<br>
                    "අපේක්ෂා" පළමු අදියර <br>
                    <ul>
                        <li>🗓 - 2020/12/26</li>
                        <li>🏥 - මහරගම අපේක්ෂා රෝහල</li>
                        <li>🕙 - පෙ.ව. 10.00</li>
                    </ul>
                    <i> 
                        තවද, රටේ පවතින අයහපත් තත්වය නිසාවෙන් මෙම කටයුත්ත සදහා ඉතා සුලු පිරිසකට පමණක් සහභාගි වීමට අවසර ලැබී ඇති බව කරුණාවෙන් සළකන්න.
                    </i>
                </p>
            </div>
        </div> -->
...
<div class="section primary-section" id=recents>
    ...
    <div class="container">
        ...
        <h2 id="Niwarana" style="margin-bottom:20px;margin-top:40px;text-align:center">ප්‍රකම්පන</h2>

        <div id="Prakampana" class="row-fluid" style="margin-bottom:20px">
            <div class="span8">
                <img src="<?php echo base_url() ?>assets/contents/images/tempory/Prakampana phase1 Thank you.jpeg">
            </div>
            <div class="span4">
                <p>
                    Thank you for being with "Prakampana"!<br>
                    <br>
                    Hope you had an unforgettable experience!<br>
                    <br>
                    <b> #ප්‍රකම්පන<br>
                        #තුම්මුල්ලේ_සිංහයෝ <br>
                        #UOC_Leos<br>
        ...
        <h2 id="Niwarana" style="margin-bottom:20px;margin-top:40px;text-align:center">නිවාරණ 2020</h2>

        <div class="row-fluid" style="margin-bottom:20px">
            <div class="row-fluid" style="margin-bottom:20px">
                <div class="span8">
                    <img src="<?php echo base_url() ?>assets/contents/images/tempory/Niwarana Winners.jpeg">
                </div>
                <div class="span4">
                    <p>
                        සමස්ත ලොව පුරාම දිනෙන් දින පැතිරී යන මත්ද්‍රව්‍ය උවදුර තුරන් කිරීමෙහිලා , සිය සමාජ වගකිම නිවැරදිව වටහාගත් ලියෝවරුන් වශයෙන් අප දියත් කළ කෙටි නාට්‍ය පිටපත් තරගාවලියේ (පළමු අදියර) සාඩම්බර ජයග්‍රාකයින්ට උණුසුම් සුබ පැතුම් ....!<br>
                        <br>
                        ජයග්‍රාහී සියලු දෙනාට සහ නාට්‍ය නිර්මාණ අප වෙත එවා මෙම මහගු ප්‍රයත්නයේ කොටස්කරුවන් වූ සියලු දෙනාට අපගේ ස්තූතිපූර්වක සුභ පැතුම්...! <br>
                        <br>
                        <b> #නිවාරණ_2020<br>
                            #තුම්මුල්ලේ_සිංහයෝ <br>
                            #UOC_Leos<br>
                            #Leo_District_306C1<br>
                            #MD_306
                        </b>
                    </p>
                </div>
