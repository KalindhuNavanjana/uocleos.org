...
<div id=announcements class="section secondary-section">
    ...
    <div class="container">
        ...
        <div id="Be-Their-Vision" class="row-fluid" style="margin-bottom:20px">
            <div class="span8">
                <img src="<?php echo base_url() ?>assets/contents/images/tempory/Be_their_vision_5.0.jpeg">
            </div>
            <div class="span4">
                <p>
                    කොරෝනාව නිසා නිවසේ සිට වැඩ කරනා ඔබට තාක්ෂණික උපකරණ දෙස වරුගනන් බලා සිටීමට සිදු වෙලාද❓<br>
                    මේ නිසා ඔබේ දෑස් විනාශයට පත් වන බව ඔබ දන්නවාද❓<br>
                    ඔබව ජීවත් කරනා ඔබේ දෑස් රැකගැනීමට ඔබත් කැමතිද❓<br>
                    මේ එළඹෙන්නේ ඔබ ඔබේ දැස් රැකගත යුතුම කාලයයි.<br>
                    නිසියාකාරයෙන් දැනුවත්ව ඔබේ දෑස් රැක ගන්න...  <br>
                    අපි සූදානම් ඔබට ඒ දැනුම ලබාදීමට🤝..<br>
                    බලාපොරොත්තු වන්න....<br>
                    බොඳවූ ඡායාවන් තුළ සුපැහැදිළි දසුන් මවනා<br>
                    <br>
                    <b>Be Their Vision 5.0</b> පළමු අදියර <br>
                    <br>
                    <b>
                        #Be_Their_Vision_5.0 <br>
